# electron-gridstack-boilerplate

A minimalistic boilerplate for [Electron runtime](http://electron.atom.io) with jQuery, jQuery-UI, and [Gridstack](https://github.com/gridstack/gridstack.js). This boilerplate (and most of this README) is based off of the [electron-boilerplate project](https://github.com/szwacz/electron-boilerplate)

This project contains only bare minimum of dependencies. 
